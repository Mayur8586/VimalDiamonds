        ...
        <div class="row g-0 mx-lg-0">
            <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                <div class="p-lg-5 ps-lg-0">
                    ...
                    <p class="mb-4 pb-2" style="text-align: justify;">Now you have the power to grow your business in
                        international markets with {{ $data->companyname }}. With together supercharge our businesses.
                    </p>
                    <div class="row g-4">
                        <div class="col-6">
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
            <div class="testimonial-item text-center">
                ...
                <div class="testimonial-text text-center rounded p-4">
                    <p>Gorgeous stone! Prettier than my earth mined diamond. Secure & fairly fast shipping by Fed-Ex. Seller easy to work with. Definitely will consider future purchases from the seller.
                    </p>
            ...
            <div class="testimonial-item text-center">
                ...
                <div class="testimonial-text text-center rounded p-4">
                    <p>thank you! Beautiful stones exactly as described! Very fast delivery! The seller very patient with me and my questions, very professional and nice to work with I would not hesitate to buy again
                    </p>
                    <h5 class="mb-1">Peter Johnson</h5>
            ...
            <div class="testimonial-item text-center">
                ...
                <div class="testimonial-text text-center rounded p-4">
                    <p>Perfect transaction! The diamond is exactly as described and a great price too!
                    </p>
                    <h5 class="mb-1">Pattricks James</h5>
